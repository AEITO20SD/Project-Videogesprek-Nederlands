...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 05 dec 2022 om 09:51
...
--
ALTER TABLE `assignment_has_video`
  ADD CONSTRAINT `fk_Assignment_has_Video_Assignment1` FOREIGN KEY (`assignmentId`) REFERENCES `assignment` (`id`),
  ADD CONSTRAINT `fk_Assignment_has_Video_Video1` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`);

--
-- Beperkingen voor tabel `docent_has_assignment`
--
ALTER TABLE `docent_has_assignment`
  ADD CONSTRAINT `fk_Assignment_has_Docent_Assignment1` FOREIGN KEY (`assignmentId`) REFERENCES `assignment` (`id`),
  ADD CONSTRAINT `fk_Assignment_has_Docent_Docent1` FOREIGN KEY (`docentId`) REFERENCES `docent` (`id`);
...
--
ALTER TABLE `participant_has_video`
  ADD CONSTRAINT `fk_Video_has_Participant_Participant1` FOREIGN KEY (`participantId`) REFERENCES `participant` (`id`),
  ADD CONSTRAINT `fk_Video_has_Participant_Video1` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`);

--
-- Beperkingen voor tabel `room`
--
ALTER TABLE `room`
  ADD CONSTRAINT `fk_assignment1` FOREIGN KEY (`assignmentId`) REFERENCES `assignment` (`id`),
  ADD CONSTRAINT `fk_docent1` FOREIGN KEY (`ownerId`) REFERENCES `docent` (`id`);

--
-- Beperkingen voor tabel `video`
--
ALTER TABLE `video`
  ADD CONSTRAINT `fk_assignment` FOREIGN KEY (`assignmentId`) REFERENCES `assignment` (`id`);
COMMIT;
